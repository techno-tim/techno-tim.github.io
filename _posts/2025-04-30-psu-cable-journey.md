...
Seasonic only includes **one** 6-pin to 4-pin Molex cable, and I needed four. Worse, the backplane is powered entirely via Molex, the same old 4-pin IDE-style connectors that IDE drive used (which no one has by the way). I wonder why they have no switched SATA power. It’s more available,and the cables are far more for the tight spacing underneath the HL15's backplane.  I'm assuming it's just a design that dates back to when it was first designed and since they designed the backplane they can also design any cables they want.
...
- **[ModDIY](https://www.moddiy.com/)** *could* make custom right-angle Molex cables but at ~$30 each after customizing the length. I needed 8 cables (2 servers), which would run nearly **$300** with shipping. Not the end of the world, but also not what I wanted to pay if I could find it cheaper elsewhere.
...
When the cables arrived, I didn’t plug them in immediately. I needed to make sure the pin-outs matched. I almost fried my PSU and backplane once by using the Corsair cables, I didn't want to come close to doing it again.
...
If you’re planning to swap PSUs in your HL15 or PC/server, be ready to go deep into the rabbit hole of custom cables. And yes those old Molex connectors are still around, like it or not.

The HL15 is finally back in the rack, and it's running great. Clean cables, quiet fans, and quiet and solid power delivery.
...
Also, if you're interested in this PSU it's hard to find right now.  Noctua said the demand for this CPU is much greater than they anticipated but more stock is on the way.  
