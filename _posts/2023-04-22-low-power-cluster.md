...
![Intel NUC Stack](/assets/img/posts/intel-nuc-stack.webp)
...
![Intel NUC Internals](/assets/img/posts/intel-nuc-internals.webp)
...
![Intel NUC Internals](/assets/img/posts/intel-nuc-rackmount-system.webp)
...
![Intel NUC Internals](/assets/img/posts/pikvm-interface.webp)
_Intel NUC, 1U Rack Mount System_
...
![Running the k3s-ansible playbook](/assets/img/posts/ansible-k3s-install.webp)
...
![Running the k3s-ansible playbook](/assets/img/posts/nginx-demo-site.webp)
_NGINX demo page_
...
![HA NGINX Test](/assets/img/posts/ha-nginx-test.webp)
...
![Stateless k8s apps](/assets/img/posts/k8s-stateless-apps.webp)
...
![Stateless k8s apps](/assets/img/posts/nuc-cluster-power-usage.webp)
